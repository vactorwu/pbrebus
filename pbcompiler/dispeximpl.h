...
// TODO: Thread safety.
template <class T, const IID* piid = &__uuidof(T), const GUID* plibid = &CComModule::m_libid, WORD wMajor = 1, WORD wMinor = 0, class tihclass = CComTypeInfoHolder>
...
IDispatchExImpl<T, piid, plibid, wMajor, wMinor, tihclass>::_tihclass
IDispatchExImpl<T, piid, plibid, wMajor, wMinor, tihclass>::s_tih = { piid, plibid, wMajor, wMinor, 0, 0, 0, 0 };
