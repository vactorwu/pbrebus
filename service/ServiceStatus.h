...
//typedef DWORD (WINAPI *LPHANDLER_FUNCTION_EX)(
    //DWORD dwControl, DWORD dwEventType, PVOID pvEventData, PVOID pvContext
//    );
...
public:
   ...
   BOOL Initialize(LPCTSTR szServiceName, LPHANDLER_FUNCTION_EX pfnHandler, 
...
BOOL CServiceStatus::Initialize(LPCTSTR szServiceName, 
