...
typedef SCC_return (_cdecl *FPSCCINITIALIZE)
...
typedef SCC_return (*FPSCCUNINITIALIZE)(void *context_arg);

typedef SCC_return (*FPSCCOPENPROJECT)
...
typedef SCC_return (*FPSCCCLOSEPROJECT) (void *context_arg);

/* cvs get.  */
typedef SCC_return (*FPSCCGET)
...
/* cvs edit.  */
typedef SCC_return (*FPSCCCHECKOUT)
  (void *context_arg, HWND window, 
...
/* cvs ci.  */
typedef SCC_return (*FPSCCCHECKIN)
  (void *context_arg, HWND window,
...
/* cvs unedit.  */
typedef SCC_return (*FPSCCUNCHECKOUT)
  (void *context_arg, HWND window,
...
/* cvs log, I presume.  If we want to get fancier we could bring
   ...
   do "cvs update -r", etc.  */
typedef SCC_return (*FPSCCHISTORY)
  (void *context_arg, HWND window,
...
typedef SCC_return (*FPSCCGETCOMMANDOPTIONS)
  (void *context_arg, HWND window,
...
typedef SCC_return (*FPSCCPOPULATELIST)
...
typedef SCC_return (*FPSCCGETPROJPATH)
  (void *context_arg, HWND window, LPSTR user,
...
typedef SCC_return (*FPSCCADDFROMSCC)
  (void *context_arg, HWND window,
