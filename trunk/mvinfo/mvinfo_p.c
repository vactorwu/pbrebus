...
/* Object interface: IVersionInfo, ver. 0.0,
   GUID={0x6869846A,0x588B,0x40BB,{0x97,0xCB,0x00,0x48,0xDB,0x57,0xBE,0xD7}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IVersionInfo_ServerInfo;
...
static const unsigned short IVersionInfo_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IVersionInfo_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IVersionInfo_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IVersionInfo_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IVersionInfo_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(34) _IVersionInfoProxyVtbl = 
{
    &IVersionInfo_ProxyInfo,
    &IID_IVersionInfo,
    ...
    (void *)-1 /* IVersionInfo::load */ ,
    (void *)-1 /* IVersionInfo::get_FileVersion */ ,
    (void *)-1 /* IVersionInfo::put_FileVersion */ ,
    (void *)-1 /* IVersionInfo::get_ProductVersion */ ,
    (void *)-1 /* IVersionInfo::put_ProductVersion */ ,
    (void *)-1 /* IVersionInfo::get_Mode */ ,
    (void *)-1 /* IVersionInfo::put_Mode */ ,
    (void *)-1 /* IVersionInfo::get_Description */ ,
    (void *)-1 /* IVersionInfo::put_Description */ ,
    (void *)-1 /* IVersionInfo::get_Copyright */ ,
    (void *)-1 /* IVersionInfo::put_Copyright */ ,
    (void *)-1 /* IVersionInfo::get_CompanyName */ ,
    (void *)-1 /* IVersionInfo::put_CompanyName */ ,
    (void *)-1 /* IVersionInfo::get_InternalName */ ,
    (void *)-1 /* IVersionInfo::put_InternalName */ ,
    (void *)-1 /* IVersionInfo::get_ProductName */ ,
    (void *)-1 /* IVersionInfo::put_ProductName */ ,
    (void *)-1 /* IVersionInfo::get_Comments */ ,
    (void *)-1 /* IVersionInfo::put_Comments */ ,
    (void *)-1 /* IVersionInfo::get_LegalTrademarks */ ,
    (void *)-1 /* IVersionInfo::put_LegalTrademarks */ ,
    (void *)-1 /* IVersionInfo::get_OriginalFilename */ ,
    (void *)-1 /* IVersionInfo::put_OriginalFilename */ ,
    (void *)-1 /* IVersionInfo::get_SpecialBuild */ ,
    (void *)-1 /* IVersionInfo::put_SpecialBuild */ ,
    IVersionInfo_setProperty_Proxy ,
    IVersionInfo_getProperty_Proxy
};


static const PRPC_STUB_FUNCTION IVersionInfo_table[] =
{
...
CInterfaceStubVtbl _IVersionInfoStubVtbl =
{
    &IID_IVersionInfo,
    &IVersionInfo_ServerInfo,
    34,
    &IVersionInfo_table[-3],
...
/* 354 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 356 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 466 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 468 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 494 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 496 */	NdrFcShort( 0x2c ),	/* Type Offset=44 */
...
/* 522 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 524 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 550 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 552 */	NdrFcShort( 0x2c ),	/* Type Offset=44 */
...
/* 586 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_OriginalFilename */
...
/* 634 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 636 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 690 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 692 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 718 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 720 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 724 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
			...
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 726 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 752 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 754 */	NdrFcShort( 0x1a ),	/* Type Offset=26 */
...
/* 758 */	NdrFcShort( 0x8 ),	/* x86, MIPS, PPC Stack size/offset = 8 */
			...
			NdrFcShort( 0x10 ),	/* Alpha Stack size/offset = 16 */
#endif
/* 760 */	NdrFcShort( 0x2c ),	/* Type Offset=44 */
...
const CInterfaceProxyVtbl * _mvinfo_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IVersionInfoProxyVtbl,
    0
};

const CInterfaceStubVtbl * _mvinfo_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IVersionInfoStubVtbl,
    0
};

PCInterfaceName const _mvinfo_InterfaceNamesList[] = 
{
    "IVersionInfo",
    0
};

const IID *  _mvinfo_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _mvinfo_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _mvinfo, pIID, n)

int __stdcall _mvinfo_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_mvinfo_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo mvinfo_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _mvinfo_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _mvinfo_StubVtblList,
    (const PCInterfaceName * ) & _mvinfo_InterfaceNamesList,
    (const IID ** ) & _mvinfo_BaseIIDList,
    & _mvinfo_IID_Lookup, 
    1,
    2,
